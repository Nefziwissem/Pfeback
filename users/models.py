...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    departement = models.CharField(max_length=100, blank=True, null=True)  # Example field definition
    role_features = models.JSONField(blank=True, null=True)
